...
var figureCount = 3;
var favContainer = document.querySelector(".favorite-container");
var imgSelections;
var btnSelections;
...
function zoomFig() {
   ...
   var winOptions = "width=960,height=650";
...
/* update function */
const myInterval = setInterval(updateImage, 1);
function updateImage() {
   imgSelections = document.querySelectorAll(".favorite-container img");
   btnSelections = document.querySelectorAll(".favorite-container button");

}
/* remove one img if reaching limit */
favContainer.addEventListener("mouseover", function () {
   imgSelections.forEach(function (item) {
      item.addEventListener("click", function (e) {
         var btnRemove = document.createElement("button");
         btnRemove.innerHTML = "remove";                 
         if (e.target.previousSibling.innerHTML !== "remove") {
            favContainer.insertBefore(btnRemove, e.target);
         }
      });
   });
   btnSelections.forEach(function (item) {
      item.addEventListener("click", function (e) {
